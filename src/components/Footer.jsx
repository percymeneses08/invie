      ...
      <footer className="footer">
        <div className="contenedor">
          <div className="contacto">
            ...
            <a href="tel:+573024456678"><strong>Telefono</strong></a>
            <a href="mailto:contacto@invie.com"><strong>E-mail</strong></a>
          </div>
            ...
            <div className="col1">
              ...
              <div className="intereses">
                <label htmlFor="cotizacion">
                  <input type="checkbox" id="cotizacion" defaultChecked name="intereses" value="cotizacion"/> Cotizacion
                </label>
